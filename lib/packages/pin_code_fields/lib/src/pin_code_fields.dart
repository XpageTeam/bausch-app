...
class _PinCodeTextFieldState extends State<PinCodeTextField>
  ...
  // ignore: member-ordering-extended
  HapticFeedback? runHapticFeedback() {
  ...
  //МОЯ МОДИФИКАЦИЯ
  double _getBorderRadiusFromIndex(int index) {
    final double activeRadius = 5;
    final double defaultRadius = 180;
    if (!widget.enabled) {
      return defaultRadius;
    }
    if (((_selectedIndex == index) ||
            (_selectedIndex == index && index == widget.length)) &&
        _focusNode!.hasFocus) {
      return defaultRadius;
    } else if (_selectedIndex > index) {
      return activeRadius;
  ...
  double _getBoxHeightFromIndex(int index) {
    final double activeHeight = 99;
    final double defaultHeight = 63;
      ...
      result.add(
        Container(
          ...
          child: AnimatedContainer(
            ...
            height: _getBoxHeightFromIndex(i),
            decoration: BoxDecoration(
              ...
              shape: _pinTheme.shape == PinCodeFieldShape.circle
                  ? BoxShape.circle
                  : BoxShape.rectangle,
              borderRadius: BorderRadius.circular(_getBorderRadiusFromIndex(i)),
