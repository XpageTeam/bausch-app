      ...
      body: ListView(
        ...
        children: [
          StreamedStateBuilder<LensProductModel?>(
            ...
            builder: (_, currendProduct) => currendProduct == null
                ? Column(
                  ...
                  Padding(
                    ...
                    child: FocusButton(
                      ...
                      onPressed: () async {
                        ...
                        await wm.rightPair
                            .accept(rightPair.copyWith(diopters: newValue));
                  ...
                  Padding(
                    ...
                    child: FocusButton(
                      ...
                      onPressed: () async {
                        ...
                        await wm.rightPair
                            .accept(rightPair.copyWith(cylinder: newValue));
                        await wm.validateFields();
                      },
                    ),
                  ),
                  Padding(
                    ...
                    child: FocusButton(
                      ...
                      onPressed: () async {
                        ...
                        await wm.rightPair
                            .accept(rightPair.copyWith(axis: newValue));
                        await wm.validateFields();
                      },
                    ),
                  ),
                  Padding(
                    ...
                    child: FocusButton(
                      ...
                      onPressed: () async {
                        ...
                        await wm.rightPair
                            .accept(rightPair.copyWith(addition: newValue));
                        await wm.validateFields();
                      },
                    ),
                  ),
                    ...
                    child: FocusButton(
                      ...
                      onPressed: () async {
                        final newValue = await showModalBottomSheet<String?>(
                            ...
                            leftPair.diopters;
                        if (newValue != null && newValue != leftPair.diopters) {
                          await wm.changeEyesEquality(areEqual: false);
                        }
                        await wm.leftPair
                            .accept(leftPair.copyWith(diopters: newValue));
                        await wm.validateFields();
                      },
                    ),
                  ),
                    ...
                    child: FocusButton(
                      ...
                      onPressed: () async {
                        final newValue = await showModalBottomSheet<String?>(
                            ...
                            leftPair.cylinder;
                        if (newValue != null && newValue != leftPair.cylinder) {
                          await wm.changeEyesEquality(areEqual: false);
                        }
                        await wm.leftPair
                            .accept(leftPair.copyWith(cylinder: newValue));
                        await wm.validateFields();
                      },
                    ),
                  ),
                    ...
                    child: FocusButton(
                      ...
                      onPressed: () async {
                        final newValue = await showModalBottomSheet<String?>(
                            ...
                            leftPair.axis;
                        if (newValue != null && newValue != leftPair.axis) {
                          await wm.changeEyesEquality(areEqual: false);
                        }
                        await wm.leftPair
                            .accept(leftPair.copyWith(axis: newValue));
                        await wm.validateFields();
                      },
                    ),
                  ),
                    ...
                    child: FocusButton(
                      ...
                      onPressed: () async {
                        final newValue = await showModalBottomSheet<String?>(
                            ...
                            leftPair.addition;
                        if (newValue != null && newValue != leftPair.addition) {
                          await wm.changeEyesEquality(areEqual: false);
                        }
                        await wm.leftPair
                            .accept(leftPair.copyWith(addition: newValue));
                        await wm.validateFields();
                      },
                    ),
                  ),
          ...
          StreamedStateBuilder<bool>(
            ...
            builder: (_, areFieldsValid) => BlueButtonWithText(
              ...
              onPressed: areFieldsValid
                  ? () async => wm.onAcceptPressed(isEditing: widget.isEditing)
                  : null,
            ),
          ),
        ],
