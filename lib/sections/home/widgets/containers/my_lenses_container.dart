...
class MyLensesContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StreamedStateBuilder<bool>(
      streamedState: myLensesWM.loadingInProgress,
      builder: (_, loadingInProgress) => StreamedStateBuilder<LensesPairModel?>(
                    ...
                    : WhiteContainerWithRoundedCorners(
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      if (myLensesWM.lensesPairModel.value !=
                                          null)
                                        Padding(
                                          padding:
                                ...
                                Padding(
                                  ...
                                  child: myLensesWM.lensesPairModel.value ==
                                              null ||
                                          currentProduct!.lifeTime == 1
                                      ? Padding(
                                          padding:
                            ...
                            if (myLensesWM.lensesPairModel.value != null &&
                                myLensesWM.lensesPairModel.value!.product!
                                        .lifeTime >
                                    1)
                              Padding(
                                padding:
                                    const EdgeInsets.only(top: 24, right: 12),
                                child: Row(
                                  children: [
                                      ...
                                      Expanded(
                                        child: GreyButton(
                                          ...
                                          onPressed: () async =>
                                            ...
                                            builder: (context) {
                                              return (leftLensDate != null &&
                                                          rightLensDate ==
                                                              null) ||
                                                      (leftLensDate == null &&
                                                          rightLensDate != null)
                                                  ? PutOnDateSheet(
                                                      leftPut: leftLensDate
                                                                  ?.dateStart !=
                                                              null
                                                          ? null
                                                          : DateTime.now(),
                                                      rightPut: rightLensDate
                                                                  ?.dateStart !=
                                                              null
                                                          ? null
                                                          : DateTime.now(),
                                                  ...
                                                  : DifferentLensesSheet(
                                                      leftDate: leftLensDate
                                                              ?.dateStart ??
                                                          DateTime.now(),
                                                      rightDate: rightLensDate
                                                              ?.dateStart ??
                                                          DateTime.now(),
                                                      onConfirmed: ({
                                                        leftDate,
